...
const Distance = () => {
  ...
  return (
    <div className="p-4 min-h-screen max-w-screen-sm mx-auto">
      {user ? (
        <>
          <h1 className="text-3xl font-bold text-center">Konversi Jarak</h1>
          <form className="flex flex-col gap-2 w-full mt-[40px]">
            <div className="flex flex-col relative gap-1">
              <label htmlFor="option">Pilih Jarak</label>
              <select
                id="option"
                className="border p-2 rounded"
                defaultValue={"meter-kilometer"}
                onChange={handleChange}
                ref={option}
              >
                <option value="meter-kilometer">Meter Ke Kilometer</option>
                <option value="kilometer-meter">Kilometer Ke Meter</option>
              </select>
            </div>
            <div className="flex flex-col relative gap-1">
